...
const TaskCard = ({ task }) => {
  ...
  return (
    <>
      <div className="w-full h-fit bg-white shadow-minimal p-4 rounded">
        <div className="w-full flex justify-between">
          <div
            className={clsx(
              "flex flex-1 gap-1 items-center text-sm font-medium mb-2",
        ...
        {task?.subTasks?.length > 0 ? (
          <div className="py-4 border-t border-gray-200">
            ...
            <div className="pt-4 pb-2 space-x-8">
              <span className="text-sm text-gray-600">
