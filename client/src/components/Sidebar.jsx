...
const Sidebar = () => {
  ...
  return (
    <div className="w-full  h-full flex flex-col">
      <h1 className="flex gap-1 items-center py-3 2xl:py-4 px-5 border-b">
      ...
      <div className="">
        <button className="w-full px-5 flex gap-2 py-2 items-center text-lg text-gray-800 hover:bg-[#2564ed2d]">
          <MdSettings />
          <span>Settings</span>
        </button>
      </div>
